...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_45f1_6384_c666_5fd6_89f2_bf19_c608_a943',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ᴍͥ ʀ  ɪ ꜱͣ ᴜͫ ʀ ᴜ  x',
  AUTO_STATUS_VIEWS: toBool(process.env.AUTO_STATUS_VIEWS || 'true'),
  WELCOME_MSG: process.env.WELCOME_MSG || 'Hi @user Welcome to @gname',
  GOODBYE_MSG: process.env.GOODBYE_MSG || 'Hi @user It was Nice Seeing you',
  AUTHOR: process.env.AUTHOR || 'ᴍͥ ʀ  ɪ ꜱͣ ᴜͫ ʀ ᴜ  x',
